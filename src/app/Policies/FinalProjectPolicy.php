...
class FinalProjectPolicy
{
    ...
    {
        return $user->can('view_any_final::project');
    }
    ...
    {
        return $user->can('view_final::project');
    }
    ...
    {
        return $user->can('create_final::project');
    }
    ...
    {
        return $user->can('update_final::project');
    }
    ...
    {
        return $user->can('delete_final::project');
    }
    ...
    {
        return $user->can('delete_any_final::project');
    }
     ...
     */
    public function replicate(User $user, FinalProject $finalProject): bool
    {
